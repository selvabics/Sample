...
//            toVC.view?.transform = (xForm?.scaledBy(x: 2.0, y: 2.0))!
//            UIView.animate(withDuration: self.transitionDuration(using: transitionContext), animations: {() -> Void in
//                toVC.view?.alpha = 1
//                toVC.view?.transform = (xForm?.scaledBy(x: 1.0, y: 1.0))!
//                fromVC.view?.transform = (fromVC.view?.transform.scaledBy(x: 0.9, y: 0.9))!
...
//            let xForm: CGAffineTransform = toVC.view.transform
//            toVC.view.transform = toVC.view.transform.scaledBy(x: 0.9, y: 0.9)
//            UIView.animate(withDuration: self.transitionDuration(using: transitionContext), animations: {() -> Void in
//                fromVC.view.alpha = 0
//                fromVC.view.transform = xForm.scaledBy(x: 2.0, y: 2.0)
